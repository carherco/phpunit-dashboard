 ...
 */
final class Version20220514095306 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE test_case (id INT AUTO_INCREMENT NOT NULL, test_suite_id INT NOT NULL, name VARCHAR(255) NOT NULL, class VARCHAR(255) NOT NULL, classname VARCHAR(255) NOT NULL, file LONGTEXT NOT NULL, line INT NOT NULL, assertions INT NOT NULL, time DOUBLE PRECISION NOT NULL, status VARCHAR(255) NOT NULL, message LONGTEXT DEFAULT NULL, failure_type VARCHAR(255) DEFAULT NULL, INDEX IDX_7D71B3CBDA9FBE4E (test_suite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE test_execution (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE test_report (id INT AUTO_INCREMENT NOT NULL, tag VARCHAR(255) NOT NULL, tests INT NOT NULL, assertions INT NOT NULL, errors INT NOT NULL, warnings INT NOT NULL, failures INT NOT NULL, skipped INT NOT NULL, time DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE test_execution');
